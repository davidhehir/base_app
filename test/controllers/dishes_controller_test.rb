...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { name: @dish.name, order_id: @dish.order_id, price: @dish.price, restaurant_id: @dish.restaurant_id }
    end
  ...
  test "should update dish" do
    patch :update, id: @dish, dish: { name: @dish.name, order_id: @dish.order_id, price: @dish.price, restaurant_id: @dish.restaurant_id }
    assert_redirected_to dish_path(assigns(:dish))
  end
